...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "MULT", "DIV", "$accept", "input", "statement_list",
  "statement", "exp", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* statement: exp SEMICOLON  */
#line 31 "calc.y"
...
#line 35 "calc.y"
                   { (yyval.num_val) = (yyvsp[-2].num_val) + (yyvsp[0].num_val);}
#line 1152 "y.tab.c"
    break;
